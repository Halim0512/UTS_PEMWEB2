      ...
      <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-5xl font-extrabold mt-6">Halim Wiko</h1>
        ...
        <div className="p-10 grid md:grid-cols-2 gap-10">
          ...
          <div>
            ...
            <div className="space-y-5 text-gray-700 text-lg">
              <div>
                <span className="font-semibold text-black">Nama:</span> Halim
                Wiko Abiyunna
              </div>

              <div>
                <span className="font-semibold text-black">NIM:</span> 24090118
              </div>

              <div>
                <span className="font-semibold text-black">Program Studi:</span>{" "}
                Rekayasa Informatika
              </div>

              <div>
                <span className="font-semibold text-black">Fakultas:</span>{" "}
                Rekayasa Informatika
              </div>

              <div>
                <span className="font-semibold text-black">Universitas:</span>{" "}
          ...
          <div>
            ...
            <p className="text-gray-700 leading-relaxed text-lg">
              Saya seorang yang suka hidup sehat, suka olahraga, suka makan
              makanan sehat, dan suka belajar hal baru terutama tentang
              teknologi. Saya juga suka traveling ke tempat baru untuk mencari
              pengalaman baru. Berkebun juga menjadi salah satu hobi saya untuk
              mengisi waktu luang dan menenangkan pikiran.
            </p>

            {/* SKILL */}
            <div className="mt-10">
              <h3 className="font-bold text-2xl mb-5 text-black">Teknologi</h3>
